...
import {
  PUT_ABITURIENT_PROFILE,
  GET_ABITURIENT,
  GET_DOC_SERIA_PROFILE,
  GET_DOC_TYPE_PROFILE,
  GET_NATIONALITY_PROFILE,
} from "../URLS";
...
export class HttpService {
  ...
  getDocType() {
    return this.http.get(GET_DOC_TYPE_PROFILE, {
      headers: this.addHeaders(),
      withCredentials: true,
    });
  }
  ...
  getNationality() {
    return this.http.get(GET_NATIONALITY_PROFILE, {
      headers: this.addHeaders(),
      withCredentials: true,
    });
  }
